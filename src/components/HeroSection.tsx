...
export default function HeroSection() {
  ...
  return (
    <section id="hero" className="flex items-center justify-center pt-24 pb-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="relative z-10 flex justify-center">
              <div className="w-36 h-36 rounded-full overflow-hidden shadow-2xl border-4 border-white/20">
                <ImageWithFallback
            ...
            <div className="absolute -top-4 -right-4 w-44 h-44 bg-primary/5 rounded-full blur-3xl"></div>
            <div className="absolute -bottom-4 -left-4 w-44 h-44 bg-accent/30 rounded-full blur-3xl"></div>
          </div>
        </div>
      </div>
    </section>
